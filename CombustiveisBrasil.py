...
Media_Combustivel_BRA= ca_df[['Produto', 'Valor de Venda']].groupby(by='Produto').mean().round(2)# groupby faz um agrupamento devarias linhas e junta em uma so. Nesse caso resume todo o valor de produto
display(Media_Combustivel_BRA)
